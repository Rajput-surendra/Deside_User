...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xffE09D00);
  static const Color secondary = Color(0xff0160AE);
  ...
  static const Color grad1Color = Color(0xffE09D00);
  static var grad2Color = Color(0xffE09D00);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffFF00FF);
