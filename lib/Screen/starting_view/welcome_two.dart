          ...
          child: Column(
            children: [
              ...
              Container(
                margin: EdgeInsets.symmetric(horizontal: mysize.width / 10),
                child: Text(
                  "Deside.in is a multivendor on-demand marketplace. Our services include the buying and selling of - Groceries, Food,  Pet supplies, Electronics, Furniture, Gifts, Fashion and more.",
                  textAlign: TextAlign.center,
